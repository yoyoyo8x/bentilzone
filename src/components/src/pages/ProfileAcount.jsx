    ...
    <div>
      ...
      {formData.role === "admin" ? (
        <div className="tw-w-full tw-min-h-[500px] tw-flex tw-items-center tw-flex-col tw-justify-center">
          ...
          <div
            className="tw-w-[90%] md:tw-w-[75%] tw-border tw-border-gray-200 tw-rounded-lg 
          ...
          >
            ...
            <div className="tw-w-full">
              ...
              >
                <option value="other" className="tw-bg-white">
                  Select Category
                </option>
                {Categories &&
                  Categories.map((item) => (
                    ...
                    <>
                      <label className="tw-w-full tw-h-full tw-flex tw-flex-col tw-items-center tw-justify-center tw-cursor-pointer">
                        <div className="tw-w-full tw-h-full tw-flex tw-flex-col tw-items-center tw-justify-center tw-cursor-pointer">
                          ...
                          <p className="tw-text-gray-500 hover:tw-text-gray-700">
                    ...
                    <>
                      <div className="tw-relative tw-h-full">
                        ...
                        <button
                          ...
                          onClick={deleteImage}
                        >
                          <MdDelete className="tw-text-white" />
                        </button>
                      </div>
                    </>
                  )}
            ...
            <div className="tw-flex tw-items-center tw-w-full">
              <button
                type="button"
                className="tw-ml-0 md:tw-ml-auto tw-w-full md:tw-w-auto tw-border-none tw-outline-none tw-bg-emerald-500 tw-px-12 tw-py-2 tw-rounded-lg tw-text-white tw-font-semibold"
                onClick={saveDetails}
              >
                Save
              </button>
