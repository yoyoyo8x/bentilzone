...
function PaybyQR(){
    return(
        <div className="tw-flex tw-flex-col">
            <div className="tw-flex tw-justify-center tw-font-sans tw-font-bold tw-text-[30px] tw-text-orange-500 tw-my-2 tw-bg-cartBg tw-rounded-[2rem]">You Can Choose One Of Them</div>
            <div className="tw-flex">
            { CheckoutList && CheckoutList.map(List => (
                <div 
                    key={List.id}
                    className="tw-flex tw-flex-col tw-items-center tw-flex-1 tw-gap-2 tw-my-5 tw-bg-cartBg tw-mx-2 tw-rounded-[2rem]"                
                >
                    <div className="tw-text-gray-50 tw-text-base tw-mt-2">{List.name}</div>
                    <div className="tw-text-gray-50 tw-text-base">{List.stk}</div>
                    <div className="tw-w-[200px] tw-h-[230px]">
