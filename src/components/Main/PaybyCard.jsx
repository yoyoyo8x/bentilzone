...
function PaybyCard({ info, setInfo, pay, cardHolderError, cardNumberError, cardTypeError, expiryError, cvvError }) {
            ...
            <div className="submit-content tw-w-[800px] tw-flex-col">
                <div className="submit-info">
                    <input
                        ...
                        onChange={(e) =>
                            setInfo({ ...info, cardHolder: e.target.value })
                        }
                    />
                    ...
                    >
                        ...
                        <option value="CommercialCredit Cards">Commercial Credit Cards</option>
                    ...
                    <div className="tw-flex tw-w-full tw-gap-2">
                        <div className="tw-flex tw-flex-col tw-flex-1">
                            <input
                                ...
                                type="date"
                                id="third-n"
                                onChange={(e) => setInfo({ ...info, expiryCard: e.target.value })}
                            />
