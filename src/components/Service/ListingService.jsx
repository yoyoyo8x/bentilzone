  ...
  return (
    <div className="tw-flex tw-justify-center">
      <div className="heading-service | tw-flex tw-flex-col tw-items-center tw-justify-center tw-drop-shadow-xl">
        ...
        <h5 className="tw-text-center tw-mt-5 tw-text-slate-400 tw-text-xl tw-tracking-wider">
          Shipping national wide with great service
        </h5>
        <img
          className="heading-img"
          src="http://localhost:3000/bentilzone/static/media/heroBg.c43c4862422e70d88698.png"
          alt=""
        />
      </div>
    </div>
